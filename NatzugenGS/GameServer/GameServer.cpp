...
int APIENTRY WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nCmdShow)
{
	...
	// ----
	//MessageBoxA(0, "Free Server Files from MuServer.org \n Do not Sell", "Free GameServer", MB_ICONINFORMATION | MB_OK);
	//return msg.wParam;
}
		...
		case WM_LOG_PAINT:
			{
				...
				//revisar color log 0
				FillRect(hdc, &rect, (HBRUSH)GetStockObject(BLACK_BRUSH/*GRAY_BRUSH*/));
				ReleaseDC(hWnd, hdc);
		...
		case WM_SECOND_MSG_PROCESS:
			{
				...
				int IsGSRestart = GetPrivateProfileInt("GSRestart", "IsGSRestart", 0, gDirPath.GetNewPath("Custom\\GSRestart.ini"));
