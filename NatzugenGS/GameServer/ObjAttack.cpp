				...
				case 219:
					{
						...
						if( lpTargetObj->Type == OBJ_MONSTER )
						{
							Rate = 0; // g_SkillAdditionInfo.m_SleepRateStartVsMob + lpObj->Energy / g_SkillAdditionInfo.m_SleepRateDivVsMob + lpObj->m_Curse / 6;
						...
						{
							Rate = 0; // g_SkillAdditionInfo.m_SleepRateStartVsUser + lpObj->Energy / g_SkillAdditionInfo.m_SleepRateDivVsUser + lpObj->m_Curse / 6;
						...
						if( lpTargetObj->Type == OBJ_MONSTER )
						{
							SleepTime = 0;// (g_SkillAdditionInfo.m_SleepTimeStartVsMob + lpObj->Energy / g_SkillAdditionInfo.m_SleepTimeDivVsMob) - lpTargetObj->Level / 20;
						...
						{
							SleepTime = 0; // g_SkillAdditionInfo.m_SleepTimeStartVsUser + ((lpObj->Energy / g_SkillAdditionInfo.m_SleepTimeDivVsUser) + (lpObj->Level - lpTargetObj->Level) / 100);
				...
				case 221:
					{
						...
						if( Rate >= rand() % 100 )
						{
							...
							if( lpTargetObj->Type == OBJ_MONSTER )
							{
								...
								DecValue = 0; // g_SkillAdditionInfo.m_WeaknessEffectStartVsMob + MaxEnergy / g_SkillAdditionInfo.m_WeaknessEffectDivVsMob;
								...
								DecTime = 0; // g_SkillAdditionInfo.m_WeaknessTimeStartVsMob + MaxEnergy / g_SkillAdditionInfo.m_WeaknessTimeDivVsMob - lpTargetObj->Level / 20;
							...
							else if( lpTargetObj->Type == OBJ_USER )
							{
								...
								DecValue = 0; // g_SkillAdditionInfo.m_WeaknessEffectStartVsUser + MaxEnergy / g_SkillAdditionInfo.m_WeaknessEffectDivVsUser;
								...
								DecTime = 0; // g_SkillAdditionInfo.m_WeaknessTimeStartVsUser + MaxEnergy / g_SkillAdditionInfo.m_WeaknessTimeDivVsUser + (lpObj->Level - lpTargetObj->Level) / 150;
				...
				case 222:
					{
						...
						if( Rate >= rand()%100 )
						{
							...
							if( lpTargetObj->Type == OBJ_MONSTER )
							{
								...
								DecValue = 0; // g_SkillAdditionInfo.m_InnovationEffectStartVsMob + MaxEnergy / g_SkillAdditionInfo.m_InnovationEffectDivVsMob;
								...
								DecTime = 0; // g_SkillAdditionInfo.m_InnovationTimeStartVsMob + MaxEnergy / g_SkillAdditionInfo.m_InnovationTimeDivVsMob - lpTargetObj->Level / 20;
							...
							else if( lpTargetObj->Type == OBJ_USER )
							{
								...
								DecValue = 0; // g_SkillAdditionInfo.m_InnovationEffectStartVsUser + MaxEnergy / g_SkillAdditionInfo.m_InnovationEffectDivVsUser;
								...
								DecTime = 0; // g_SkillAdditionInfo.m_InnovationTimeStartVsUser + MaxEnergy / g_SkillAdditionInfo.m_InnovationTimeDivVsUser + (lpObj->Level - lpTargetObj->Level) / 150;
