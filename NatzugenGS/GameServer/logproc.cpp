...
void LogTextPaintProc(HWND hWnd)
{
	...
	while(total-- != 0)
	{
		...
		case 2:
			...
			break;
		case 3:
			SetTextColor(hdc, RGB(102, 255, 153));
			break;
		case 4:
			SetTextColor(hdc, RGB(153, 0, 255));
			break;
		case 5:
	...
	//char msg[255] = "Developer: Natzugen | Free Files from muserver.org | do not sell";
	//SetTextColor(hdc, RGB(255, 10, 33));
	//TextOut(hdc, GAMESERVER_WIDTH / 2 - 250, GAMESERVER_HEIGHT, msg, strlen(msg));
