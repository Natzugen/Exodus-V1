...
void CMasterLevelSkillTreeSystem::MLS_KnightSkillAddLife(LPOBJ lpObj,CMagicInf *lpMagic)
{
	...
	// ----
	iLifeTime = 0; // g_SkillAdditionInfo.m_SwellLifeTimeStart + (lpObj->Energy + lpObj->AddEnergy) / g_SkillAdditionInfo.m_SwellLifeTimeDiv;
	// ----
...
int CMasterLevelSkillTreeSystem::MLS_SkillStrengthenMagicPower(LPOBJ lpObj,CMagicInf *lpMagic,int aTargetIndex)
{
	...
	float fSkillValue = this->GetMasterSkillValue(MagicDamageC.SkillGet(lpMagic->m_Skill),lpMagic->m_Level);
	int nEffectValue = 0; // (float)(lpObj->Energy / g_SkillAdditionInfo.m_WizardryEnchantDamageDiv) * (float)g_SkillAdditionInfo.m_WizardryEnchantDamageFact;
...
int CMasterLevelSkillTreeSystem::MLS_SkillStrengthenBerserker(int aIndex,CMagicInf *lpMagic)
{
	...
	int iDuration = 0; // g_SkillAdditionInfo.m_BerserkerTimeStart + lpObj->Energy / g_SkillAdditionInfo.m_BerserkerTimeDiv;
...
void CMasterLevelSkillTreeSystem::MLS_SkillStrendthenAddCriticalDamage(int aIndex,int aTargetIndex,CMagicInf *lpMagic)
{
	...
	int addcriticaldamagevalue = 0;// (lpObj->Energy + lpObj->AddEnergy) / g_SkillAdditionInfo.m_CriticalDamageEffectDiv2 + (lpObj->Leadership + lpObj->AddLeadership) / g_SkillAdditionInfo.m_CriticalDamageEffectDiv1;
	...
	int SkillTime = 0; // g_SkillAdditionInfo.m_CriticalDamageTimeStart + (lpObj->Energy + lpObj->AddEnergy) / g_SkillAdditionInfo.m_CriticalDamageTimeDiv;
...
void CMasterLevelSkillTreeSystem::MLS_SkillSkillFulAddCriticalDamage(int aIndex,int aTargetIndex,CMagicInf *lpMagic)
{
	...
	int SkillTime = 0;// g_SkillAdditionInfo.m_CriticalDamageTimeStart + (lpObj->Energy + lpObj->AddEnergy) / g_SkillAdditionInfo.m_CriticalDamageTimeDiv + this->GetMasterSkillValue(MagicDamageC.SkillGet(lpMagic->m_Skill), lpMagic->m_Level);
...
void CMasterLevelSkillTreeSystem::MLS_SkillMasteryAddCriticalDamage(int aIndex,int aTargetIndex,CMagicInf *lpMagic)
{
	...
	float fSkillValue = this->GetBrandOfMasterSkillValue(lpObj,lpMagic->m_Skill,1);
	int SkillTime = 0; // g_SkillAdditionInfo.m_CriticalDamageTimeStart + (lpObj->Energy + lpObj->AddEnergy) / g_SkillAdditionInfo.m_CriticalDamageTimeDiv + fSkillValue;
