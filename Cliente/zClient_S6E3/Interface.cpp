...
Naked(CharacterInfoExtern)
{
	...
	// ----
	//sprintf(info, "Master Level: d% |Master Exp: %d", gObjUser.m_MasterLevel, gObjUser.m_MasterExp);
	//-----
	_asm
	{
...
void Interface::Load()
{
	...
	//------------0x7882
	//this->BindObject(eTOP_MAIN, 0x7A5A, 467, 312, -1, -1);
	//this->BindObject(eTOP_SEPARATOR, 0x7B5E, 82, 2, -1, -1);
	//this->BindObject(eTOP_CLOSE, 0x7EC5, 36, 29, -1, -1);
	//this->BindObject(eTOP_NEXT, 0x7BAB, 17, 17, -1, -1);
	//this->BindObject(eTOP_PREV, 0x7BAA, 17, 17, -1, -1);
	//------------
...
void Interface::LoadImages()
{
	...
	//pLoadImage("Custom\\Interface\\UIWindow.jpg", 0x7882, 0x2601, 0x2900, 1, 0);
	// ----
	pLoadSomeForm();
}
// ----------------------------------------------------------------------------------------------
...
void Interface::DrawOffExpSwitch()
{
	...
	{
		this->DrawToolTip(MAX_WIN_WIDTH-57, 25, "Offline Mode");
		// ----
	...
	// ----
	this->DrawFormat(eBrown, MAX_WIN_WIDTH - 57, 8, 55, 1, "OffExp");
}
// ----------------------------------------------------------------------------------------------
...
void Interface::DrawTime()
{
	...
	char ServerTime[30];
	sprintf(ServerTime, "%2d:%02d:%02d", (ServerT->tm_hour-5)%24, ServerT->tm_min, ServerT->tm_sec);
	// -----
